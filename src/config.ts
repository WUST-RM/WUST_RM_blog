...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/1.webp", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "WUST_RM",
	bio: "欢迎来到崇实战队算法组的博客！😇🥰😍",
	typewriter: {
...
export const commentConfig: CommentConfig = {
	...
	giscus: {
		repo: "qingfengava/qing_feng_blog_discussion",
		repoId: "R_kgDOSgnj0A",
		category: "Announcements",
		categoryId: "DIC_kwDOSgnj0M4C9SzX",
		mapping: "pathname",
		strict: "0",
		reactionsEnabled: "1",
		emitMetadata: "0",
...
export const announcementConfig: AnnouncementConfig = {
	title: "WUST_RM", // 公告标题，填空使用i18n字符串Key.announcement
	content: "欢迎来到崇实战队算法组的博客！😇🥰😍", // 公告内容
